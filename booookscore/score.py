...
class Scorer():
    def __init__(self,
        ...
        self.all_labels = ['entity omission', 'event omission', 'causal omission', 'salience', 'discontinuity',
...
if __name__ == "__main__":
    ...
    parser.add_argument("--v2", action="store_true",
                        help="use v2, which batches sentences during annotation (this setup was not used in the paper)")
